...
export function normalizeJob(raw, opts) {
  ...
  const job = {
    ...
    phone_cc: textOrNull(input.phone_cc),
    phone_national: textOrNull(input.phone_national),
    hubspot_id: textOrNull(input.hubspot_id),
    address: textOrNull(input.address),
    address_line1: textOrNull(input.address_line1),
    address_street: textOrNull(input.address_street),
    address_place: textOrNull(input.address_place),
    address_extra: textOrNull(input.address_extra),
    district: textOrNull(input.district),
    acs,
    notes: textOrNull(input.notes),
    notes_long: textOrNull(input.notes_long),
    ...
    created_by: textOrNull(input.created_by),
